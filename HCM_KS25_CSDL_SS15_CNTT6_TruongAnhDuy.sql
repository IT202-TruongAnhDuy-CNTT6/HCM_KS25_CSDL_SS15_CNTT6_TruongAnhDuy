...
BEGIN
	IF NEW.score <> OLD.score THEN
		INSERT INTO grade_log VALUES
        (NULL, OLD.student_id, OLD.score, NEW.score, NOW());
    END IF;
END //
DELIMITER ;
...
BEGIN
	IF OLD.score >= 4 THEN
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Lỗi: Đã qua môn nên không thể sửa điểm';
    END IF;
END //
DELIMITER ;